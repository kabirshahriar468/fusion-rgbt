...
class BasePredictor:
        ...
        with self._lock:  # for thread-safe inference
            ...
            for self.batch in self.dataset:
                ...
                for i in range(n):
                    ...
                    # print(self.args.save,Path(paths[i]))
    ...
    def write_results(self, i, p, im, s):
        ...
        # print(self.args.save,str(self.save_dir / p.name))
        # Save results
    ...
    #
    #         # 分别保存
    #         cv2.imwrite(save_path.replace('.jpg', '_part1.jpg'), im1)
    #         cv2.imwrite(save_path.replace('.jpg', '_part2.jpg'), im2)
    #
    #     elif channels == 4:
    #         # 假设4通道的图像是RGB和灰度图
    #         rgb = im[:, :, :3]  # RGB部分
    ...
    #
    #         # 分别保存
    #         cv2.imwrite(save_path.replace('.jpg', '_part1.jpg'), rgb)
    #         cv2.imwrite(save_path.replace('.jpg', '_part2.jpg'), gray)
    #
    #     else:
    #         # 处理其他情况或报错
    ...
    def save_predicted_images(self, save_path="", frame=0):
        ...
        # Save images
            ...
            self.save_image_mutichannel(im, save_path)
            # cv2.imwrite(save_path, im)
